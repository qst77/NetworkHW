...
class OtherGroupsViewController: UITableViewController {
    ...
    @IBAction func printSmth(_ sender: Any) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "otherGroupCellid", for: indexPath) as! OtherGroupsCell
        let group = otherGroups[indexPath.row] as Group
       
        
        cell.imageOtherGroup.layer.cornerRadius = 37
        cell.imageOtherGroup.image = UIImage(named: group.imageName)
        cell.nameOtherGroup.text = group.name
        return cell
    }
